        ...
        <div className="col-xl-3 col-sm-6 py-2">
          <div className="card bg-success text-white h-100">
            <div
              ...
              <h1 className="display-4">{totalUser}</h1>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-sm-6 py-2">
        ...
        <div className="card-deck">
          ...
          <div className="card card-inverse card-warning text-center">
            <div className="card-body">
              <blockquote className="card-blockquote">
                <p>
                  There are also some interesting new text classNamees for
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              breakpoint with the col-xl-* classNamees. This extra tier extends
              the media query range all the way down to 576 px. Eventhough the
              new XL tier would make one think it’s been added to support extra
            ...
            <div className="card">
              ...
              <div
                ...
                <p>
                  ...
                  <code>.card</code> classNamees instead of <code>.panel</code>.
